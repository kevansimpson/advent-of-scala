...
/**
  ...
  * use it again. Real Intcode computers support many more features than your new one, but we'll let you know what they
  ...
  *
  * &quotWith terminology out of the way, we're ready to proceed. To complete the gravity assist, you need to determine
  ...
  *
  * Find the input <b>noun</b> and <b>verb</b> that cause the program to produce the output 19690720.
  * <b>What is 100 * noun + verb?</b> (For example, if noun=12 and verb=2, the answer would be 1202.)
  */
class Day02 {
  private lazy val input = readCSVLongs("/2019/input02.txt")

  def solvePart1: Long = IVM.restoreGravityAssist(input)

  def solvePart2: Long = IVM.findTargetOutput(input)
}
